...
export const defaultSiteRegistryConfig = registrySchema.parse({
  ...
  workflows: [
    {
      id: 'single-site-inspect',
      name: 'Single-site inspect',
      description: 'Open the default site and verify its ready selector.',
      steps: [
        {
          id: 'inspect-default-site',
          siteId: defaultSiteConfig.id,
          kind: 'inspect',
          description: 'Inspect the default site home page.',
        },
      ],
    },
  ],
    ...
    workflows: [
      {
        id: 'single-site-inspect',
        name: 'Single-site inspect',
        description: 'Open the configured default site and verify its ready selector.',
        steps: [
          {
            id: 'inspect-default-site',
            siteId: defaultSite.id,
            kind: 'inspect',
            description: 'Inspect the configured default site home page.',
